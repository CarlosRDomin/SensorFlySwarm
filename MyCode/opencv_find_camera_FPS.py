...
def find_FPS(cam_id=0, test_len=10.0, showimg=True, saveimg=False, saveimgFolder="fps_test"):
	...
	cnt_diff_frames = 0
	last_frame = np.zeros((int(video_capture.get(cv2.CAP_PROP_FRAME_HEIGHT)), int(video_capture.get(cv2.CAP_PROP_FRAME_WIDTH)), 3))
	startT = datetime.now()
